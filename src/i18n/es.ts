...
export const es = {
  ...
  solution: {
    ...
    services: [
      ...
      },
      {
        ...
        inverse: true,
        primary: false,
        ctaLabel: 'Ver productos disponibles',
        ctaHref: '/productos',
        ctaExternal: false,
        ctaSecondaryLabel: 'O agenda una asesoría sin costo',
  ...
  footer: {
    ...
    product: [
      { href: '/productos', label: 'Todos los productos', external: false },
      { href: 'https://terracoreapp.co', label: 'TerraCore', external: true },
      { href: 'https://wavival.dev/root', label: 'Root', external: true },
